    ...
    companion object {
        ...
        fun voiceIdFor(gender: String, voiceLabel: String): String {
            ...
            return if (isMale) when (voiceLabel) {
                "Deep Smooth Male" -> "en-US-GuyNeural"
                "Low Velvet Male" -> "en-US-DavisNeural"
                "Silky Soft Male" -> "en-US-AndrewNeural"
                "Warm Whisper Male" -> "en-US-EricNeural"
                "Sultry Calm Male" -> "en-US-TonyNeural"
                "Midnight Male" -> "en-US-JasonNeural"
                "Soft Romance Male" -> "en-US-RogerNeural"
                "Protective Warm Male" -> "en-US-BrandonNeural"
                "Smooth Low Male" -> "en-US-SteffanNeural"
                "Soft Sexy Male" -> "en-US-AndrewNeural"
                "Velvet Lover Male" -> "en-US-DavisNeural"
                "Bedroom Whisper Male" -> "en-US-EricNeural"
                "Romantic Deep Male" -> "en-US-ChristopherNeural"
                "Slow Burn Male" -> "en-US-GuyNeural"
                "Gentle Low Male" -> "en-US-RogerNeural"
                "Smoky Soft Male" -> "en-US-TonyNeural"
                "Deep Male" -> "en-US-GuyNeural"
                "Velvet Male" -> "en-US-DavisNeural"
                "Protective Male" -> "en-US-BrandonNeural"
                "Calm Male" -> "en-US-EricNeural"
                "Motivational Male" -> "en-US-ChristopherNeural"
                "Smooth Male" -> "en-US-SteffanNeural"
